...
from .development import build_development_actions, build_learning_outcome
...
class AssessmentReport:
    ...
    development_actions: tuple[dict[str, object], ...]
    learning_outcome: dict[str, object]
    ...
    def as_dict(self) -> dict[str, object]:
        return {
            ...
            "development_actions": list(self.development_actions),
...
class CompetencyAssessor:
    ...
    def assess(self, run: RunInput) -> AssessmentReport:
        ...
        development_actions = build_development_actions(
            gates,
            development_needs,
        )
        ...
        return AssessmentReport(
            ...
            learning_outcome=build_learning_outcome(development_actions),
